...
function describe(event) {
  ...
  const map = {
    ...
    wheel_spin: `${name} girou a Roda Maiindy`,
    ...
    radio_played: `${name} iniciou Rádio Maiindy`,
    mantra_started: `${name} iniciou Mantra Maiindy`,
    room_message_sent: `${name} enviou mensagem na Sala Maiindy`,
